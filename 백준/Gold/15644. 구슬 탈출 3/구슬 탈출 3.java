...
public class Main{
    ...
    public static void main(String[] args)throws IOException {
        ...
        if(res==-1) System.out.println(-1);
            ...
            for(Loc loc = result; loc.par!=null; loc = loc.par){
                if(loc.dir==0) list.add('L');
                else if(loc.dir==1) list.add('R');
                else if(loc.dir==2) list.add('U');
                else if(loc.dir==3) list.add('D');
            }
            System.out.println(res);
            for(int i=0; i<list.size(); i++){
                System.out.printf(String.valueOf(list.get(list.size()-i-1)));
            }
        }
